...
public class AdminFamilyModel {
    String id,img,ten,sinhngay,tuoi,gioitinh,chucvu,noio,email;

    public AdminFamilyModel(String id, String img, String ten, String sinhngay, String tuoi, String gioitinh, String chucvu, String noio, String email) {
        this.id = id;
        this.img = img;
        this.ten = ten;
