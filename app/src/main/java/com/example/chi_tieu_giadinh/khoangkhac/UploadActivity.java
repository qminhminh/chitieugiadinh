            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                imageReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        a.put(Constraints.KEY_KHOANGKHAC_IMG,uri.toString());
                        a.put(Constraints.KEY_KHOANGKHAC_CAPTION,caption);
                        ...
                        Intent intent = new Intent(UploadActivity.this, KhoangKhacImageActivity.class);
